...
public class StartProcessDataTask extends AbstractManagementTask {
    ...
    public StartProcessDataTask(ScheduledTaskRepository scheduledTaskRepository,ExecutionPlanTaskRepository executionPlanTaskRepository,ParameterRepository parameterRepository){
